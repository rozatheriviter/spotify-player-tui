...
impl Command {
    ...
    Self::PlaylistsPage => "go to the user playlists page",
    Self::AlbumsPage => "go to the user albums page",
    Self::ArtistsPage => "go to the user artists page",
    Self::PlaybackPage => "go to the playback page",
